#Regresion lineal: En resumen este algoritmo predice el precio de la vivienda 
#en boston en funcion de parametros iniciales, la aplicacion es directa y sencilla,
#conocer el precio estimado de las viviendas para seber cuando comprar, vender 
#o hasta rentar (segun el precio de la vivienda).
