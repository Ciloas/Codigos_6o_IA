#Algoritmo de busqueda de la ruta mas corte en un mapa de nodos y vertices
#Aplicacion en la vida real: Encontrar en un mapeado estilo gogle maps la 
#ruta mas rapida para ir de un punto a "h" un punto "a"
import re 
